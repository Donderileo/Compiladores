java -jar target/brffmpeg-1.0-SNAPSHOT-jar-with-dependencies.jar casos-de-teste/semantico/entrada/caso1.txt casos-de-teste/semantico/saida/saida1.txt
java -jar target/brffmpeg-1.0-SNAPSHOT-jar-with-dependencies.jar casos-de-teste/semantico/entrada/caso2.txt casos-de-teste/semantico/saida/saida2.txt
